...
return [
    ...
    'recently_created_books' => 'سياسات أنشئت مؤخراً',
    'recently_created_shelves' => 'جهات أنشئت مؤخراً',
    ...
    'shelf' => 'جهات',
    'shelves' => 'الجهات',
    'x_shelves' => ':count جهات|:count جهات',
    'shelves_long' => 'جهات السياسات',
    'shelves_empty' => 'لم ينشأ أي جهات',
    'shelves_create' => 'إنشاء جهات جديد',
    'shelves_popular' => 'جهات رائجة',
    'shelves_new' => 'جهات جديدة',
    'shelves_new_action' => 'جهات جديد',
    'shelves_popular_empty' => 'ستظهر هنا الجهات الأكثر رواجًا.',
    'shelves_new_empty' => 'ستظهر هنا الجهات التي أنشئت مؤخرًا.',
    'shelves_save' => 'حفظ الجهة',
    'shelves_books' => 'سياسات على هذا الجهة',
    'shelves_add_books' => 'إضافة سياسات لهذا الجهة',
    'shelves_drag_books' => 'اسحب السياسات هنا لإضافتها في هذا الجهة',
    'shelves_empty_contents' => 'لا توجد سياسات مخصصة لهذا الجهة',
    'shelves_edit_and_assign' => 'تحرير الجهة لإدراج سياسات',
    'shelves_edit_named' => 'تحرير جهات السياسات :name',
    'shelves_edit' => 'تحرير جهات السياسات',
    'shelves_delete' => 'حذف جهات السياسات',
    'shelves_delete_named' => 'حذف جهات السياسات :name',
    'shelves_delete_explain' => "سيؤدي هذا إلى حذف جهات السياسات المسمى ':name'، ولن تحذف السياسات المتضمنة فيه.",
    'shelves_delete_confirmation' => 'هل أنت متأكد من أنك تريد حذف هذا الرف؟',
    'shelves_permissions' => 'أذونات جهات السياسات',
    'shelves_permissions_updated' => 'تم تحديث أذونات جهات السياسات',
    'shelves_permissions_active' => 'أذونات جهات السياسات نشطة',
    'shelves_permissions_cascade_warning' => 'Permissions on bookshelves do not automatically cascade to contained books. This is because a book can exist on multiple shelves. Permissions can however be copied down to child books using the option found below.',
    'shelves_copy_permissions_to_books' => 'نسخ أذونات الوصول إلى السياسات',
    'shelves_copy_permissions' => 'نسخ الأذونات',
    'shelves_copy_permissions_explain' => 'سيؤدي هذا إلى تطبيق إعدادات الأذونات الحالية لهذا الجهة على جميع السياسات المتضمنة فيه. قبل التفعيل، تأكد من حفظ أي تغييرات في أذونات هذا الجهة.',
    'shelves_copy_permission_success' => 'تم نسخ أذونات جهات السياسات إلى :count books',

    // Books
    'book' => 'سياسة',
    'books' => 'السياسات',
    'x_books' => ':count سياسة|:count سياسات',
    'books_empty' => 'لم يتم إنشاء أي سياسات',
    'books_popular' => 'سياسات رائجة',
    'books_recent' => 'سياسات حديثة',
    'books_new' => 'سياسات جديدة',
    'books_new_action' => 'سياسة جديد',
    'books_popular_empty' => 'السياسات الأكثر رواجاً ستظهر هنا.',
    'books_new_empty' => 'السياسات المنشأة مؤخراً ستظهر هنا.',
    'books_create' => 'إنشاء سياسة جديد',
    'books_delete' => 'حذف السياسة',
    'books_delete_named' => 'حذف سياسة :bookName',
    'books_delete_explain' => 'سيتم حذف سياسة \':bookName\'، وأيضا حذف جميع الفصول والصفحات.',
    'books_delete_confirmation' => 'تأكيد حذف الكتاب؟',
    'books_edit' => 'تعديل السياسة',
    'books_edit_named' => 'تعديل سياسة :bookName',
    'books_form_book_name' => 'اسم السياسة',
    'books_save' => 'حفظ السياسة',
    'books_permissions' => 'أذونات السياسة',
    'books_permissions_updated' => 'تم تحديث أذونات السياسة',
    'books_empty_contents' => 'لم يتم إنشاء أي صفحات أو فصول لهذا السياسة.',
    'books_empty_create_page' => 'إنشاء صفحة جديدة',
    'books_empty_sort_current_book' => 'فرز السياسة الحالي',
    'books_empty_add_chapter' => 'إضافة فصل',
    'books_permissions_active' => 'أذونات السياسة مفعلة',
    'books_search_this' => 'البحث في هذا السياسة',
    'books_navigation' => 'تصفح السياسة',
    'books_sort' => 'فرز محتويات السياسة',
    'books_sort_named' => 'فرز سياسة :bookName',
    ...
    'books_sort_show_other' => 'عرض سياسات أخرى',
    ...
    'book_tags' => 'وسوم السياسة',
    'shelf_tags' => 'علامات الجهة',
    'tag' => 'وسم',
    'tags' =>  'وسوم',
    ...
    'profile_not_created_books' => 'لم يتم إنشاء أي سياسات بواسطة :userName',
    'profile_not_created_shelves' => 'لم يقم "اسم المستخدم"بإنشاء أي جهات',
